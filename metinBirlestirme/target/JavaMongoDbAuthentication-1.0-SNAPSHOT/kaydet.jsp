<%-- 
    Document   : kaydet
    Created on : 28 Mar 2023, 13:13:08
    Author     : alica
--%>
...
<body>
    ...
    <jsp:useBean id="ikiCekirdek" scope="session" class="veri.Birlestir" />
    <jsp:setProperty name="ikiCekirdek" property="metin1" />
    <jsp:setProperty name="ikiCekirdek" property="metin2" />
    <jsp:setProperty name="ikiCekirdek" property="metin3" />
    <jsp:setProperty name="ikiCekirdek" property="metin4" />
    <jsp:setProperty name="ikiCekirdek" property="metin5" />
    <jsp:setProperty name="ikiCekirdek" property="metin6" />
    <jsp:setProperty name="ikiCekirdek" property="metin7" />
    <jsp:setProperty name="ikiCekirdek" property="metin8" />
    <jsp:setProperty name="ikiCekirdek" property="metin9" />
    <jsp:setProperty name="ikiCekirdek" property="metin10" />
    <% 
     ...
     //-------------
        ...
        //---------------------------------------------------
            ...
            // MongoDB veritabanındaki bir koleksiyona erişme
            MongoCollection<Document> collection = db.getCollection("tablo1");
            
             // Veri ekleme işlemi
            Document user = new Document("metin1", ilkCumle)
                    .append("metin2", ikinciCumle)
                    .append("metin3", ucuncuCumle)
                    .append("metin4", dorduncuCumle)
                    .append("metin5", besinciCumle)
                    .append("metin6", altinciCumle)
                    .append("metin7", yedinciCumle)
                    .append("metin8", sekizinciCumle)
                    .append("metin9", dokuzuncuCumle)
                    .append("metin10", onuncuCumle)
                    .append("Birleştirilmiş Metin:", birlesim);
            collection.insertOne(user);

            // Veri sorgulama işlemi
            Document query = new Document("Birleştirilmiş Metin:", birlesim);
            Document result = collection.find(query).first();
            out.println(result.toJson());

            // MongoDB veritabanı bağlantısını kapatma
            mongoClient.close();  
      %>
</body>
</html>
